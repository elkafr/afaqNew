...
class _MtgerRegisterScreenState extends State<MtgerRegisterScreen>
            ...
            Container(
              ...
              child: Text(
                _appState!.currentLang == "ar"
                    ? "اختيار أقسام الورشة"
                    : "Selection of workshop sections",
                    ...
                    if (_appState!.acceptTerms!) {
                      if (_locData != null) {
                        ...
                        FormData formData = new FormData.fromMap({
                          ...
                          "user_mapx": _locationState!.locationLatitude
                              .toString(),
                          "user_mapy": _locationState!.locationlongitude
                              .toString(),
                        ...
                        final results = await _services.postWithDio(
                          "https://mahtco.net/app/api/register_mtger",
                          body: formData,
                        );
